...
parsed_train_dataset=train_dataset.map(decode, num_parallel_calls=num_par_calls).cache().shuffle(buffer_size=1000000, seed=4242, reshuffle_each_iteration=True)
