...
from tensorflow.keras.layers import Masking, Dense, Activation, LSTM, Dropout, concatenate,LSTM
...
def decode(serialized_example):
    deser_features = tf.io.parse_single_example(
      ...
      features={
          ...
          'LSTM_input': tf.io.FixedLenFeature((801,19), tf.float32),
          'encoded_label': tf.io.FixedLenFeature((3), tf.float32),
          })
    return((deser_features['LSTM_input'], deser_features['HLF_input']), deser_features['encoded_label'])
